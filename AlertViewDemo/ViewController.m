...
- (IBAction)showAction:(id)sender {
    AlertView *alertView = [[AlertView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) title:@"提示" detail:@"预期年分红收益：指当前的预期年化收益率，收益率随市场情况会不断变化降低。" btnArray:@[@"取消",@"确定"] btnBacColorArray:@[[UIColor colorWithRed:204/255.0 green:204/255.0 blue:204/255.0 alpha:1],[UIColor colorWithRed:255/255.0 green:100/255.0 blue:48/255.0 alpha:1]] showCloseBtn:YES];
